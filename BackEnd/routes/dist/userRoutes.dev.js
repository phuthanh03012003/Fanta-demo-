...
var authMiddleware = require('../middleware/authMiddleware'); // GET
...
router.get('/get-activity', authMiddleware.isUser, userController.getActivity); // UPDATE
...
router.put('/update-reviews/:reviewId', authMiddleware.isUser, userController.updateReview); // POST
...
router.post('/save-history', authMiddleware.isUser, userController.saveHistory); // DELETE
